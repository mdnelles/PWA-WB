define("./workbox-8b4b545e.js", ["exports"], function (e) {
   "use strict";
   try {
   ...
   const t = {
      ...
      n = (e) =>
         [t.prefix, e, t.suffix].filter((e) => e && e.length > 0).join("-"),
      s = (e) => e || n(t.precache),
      i = (e) =>
   ...
   const a = (e, t) => e.filter((e) => t in e),
      ...
      h = async ({
         ...
         const d = await self.caches.open(e),
            ...
            y =
               p.length > 0
                  ? await l({ cacheName: e, matchOptions: h, request: f })
                  : null;
         try {
            await d.put(f, w);
         } catch (e) {
         ...
         try {
            ...
            for (const e of s)
               "fetchDidSucceed" in e &&
                  (i = await e.fetchDidSucceed.call(e, {
                     event: n,
                     request: r,
                     response: i,
                  }));
   ...
   class y {
         ...
         for (const n of e) {
            ...
            if ("string" != typeof n && n.integrity) {
               if (this.o.has(e) && this.o.get(e) !== n.integrity)
                  throw new o("add-to-cache-list-conflicting-integrities", {
                     url: s,
                  });
      ...
      async u({
         ...
         if (
            !(a
               ? await a.cacheWillUpdate({ event: s, request: r, response: u })
               : u.status < 400)
         )
            throw new o("bad-precaching-response", {
               url: t,
               status: u.status,
            });
      ...
      createHandlerBoundToURL(e, t = !0) {
         if (!this.getCacheKeyForURL(e))
            throw new o("non-precached-url", { url: e });
   ...
   e.precacheAndRoute = function (e, t) {
      !(function (e) {
         R().addToCacheList(e),
            e.length > 0 &&
               (self.addEventListener("install", x),
               self.addEventListener("activate", K));
      })(e),
         m(t);
   };
});
//# sourceMappingURL=workbox-8b4b545e.js.map
